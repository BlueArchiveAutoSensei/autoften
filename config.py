...
class Config:
    def __init__(self) -> None:
        ...
        self.ex_slot_pos = (900, 615, 1255, 740)  # win32带Mumu标题栏720p
        ...
        self.ex_bar_pos = (895, 740, 1248, 770)  # win32带Mumu标题栏720p
        self.tempMatch_threshold = 0.6
        self.model = None
        self.hwnd = None
        self.pos = None
        self.size = None
        self.adb_server_ip = 'localhost'
        self.adb_server_port = 5037
        self.adb_device_ip = 'localhost'
        self.adb_device_port = 16384
